...
public class AuthenticateIT {
    ...
    @Test
    public void authenticate_WithInvalidUsername_ReturnErrorMessasgeWithStatus422() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
    ...
    @Test
    public void authenticate_WithInvalidPassword_ReturnErrorMessasgeWithStatus422() {
        ErrorMessage responseBody = testClient
                .post()
                .uri("/api/v1/auth")
                .contentType(MediaType.APPLICATION_JSON)
